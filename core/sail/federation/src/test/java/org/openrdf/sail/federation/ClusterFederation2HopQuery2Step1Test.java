 ...
 * @author vagrant
 */
public class ClusterFederation2HopQuery2Step1Test {
				   ...
				   TupleQueryResult result0Hop= tupleQuery0Hop.evaluate();
					...
					while(result0Hop.hasNext()){
				      ...
				      if(!total.contains(valueOfX.toString())){
						z.add(valueOfZ.toString());	
						y.add(valueOfY.toString());
						count++;	
				      }
					}
//					List<String> y1 = .stream().distinct().collect(Collectors.toList());
					...
					FileOutputStream fosy = new FileOutputStream("/home/vagrant/results/2y");
				  ...
				  bwy.close();
					...
					FileOutputStream fosx = new FileOutputStream("/home/vagrant/results/2z");
