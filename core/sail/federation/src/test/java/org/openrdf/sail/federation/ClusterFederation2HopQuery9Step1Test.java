 ...
 * @author vagrant
 */
public class ClusterFederation2HopQuery9Step1Test {
...
//					List<String> y1 = .stream().distinct().collect(Collectors.toList());
					...
					FileOutputStream fosy = new FileOutputStream("/home/vagrant/results/y");
				  ...
				  bwy.close();
					...
					FileOutputStream fosx = new FileOutputStream("/home/vagrant/results/x");
