 ...
 * @author vagrant
 */
public class ClusterFederation2HopQuery2Step2Test {
	...
	//	List<String> locationName = new ArrayList<String>();
		...
		BufferedReader brx = new BufferedReader(
				new FileReader(new File("/home/vagrant/results/2z")));
      String linex = brx.readLine();
      z.add(linex);
      
		BufferedReader bry = new BufferedReader(
				new FileReader(new File("/home/vagrant/results/2y")));
		...
		// execute query
					...
					for (int i=0; i<y.size();i++){
						...
						String query = "prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"+
								...
								"WHERE{"+
								"<"+z.get(i)+">"+" ub:subOrganizationOf <"+y.get(i)+"> ."+
								 "}";
