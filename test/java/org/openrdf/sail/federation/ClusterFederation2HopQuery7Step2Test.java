 ...
 * @author vagrant
 */
public class ClusterFederation2HopQuery7Step2Test {
		...
		// execute query
					...
					for (int i=0; i<x.size();i++){
						...
						String query = "prefix rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>"+
								...
								"WHERE"+ 
								"{ VALUES ?Student {ub:UndergraduateStudent ub:GraduateStudent}"+
								 " VALUES ?Course {ub:Course ub:GraduateCourse}"+
								 "<"+x.get(i)+">  rdf:type ?Student ."+
								  "}";
					...
					while(result.hasNext()){
						...
						if(bindingSet.getValue("count").toString().contains("\"2\""))
